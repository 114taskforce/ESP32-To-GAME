...
// ========== 屏幕 ==========
constexpr uint16_t SCR_W = 320;
constexpr uint16_t SCR_H = 240;

// ========== 地图网格 ==========
constexpr uint8_t  GRID_SIZE    = 4;       // 每格像素
constexpr uint16_t MAP_COLS     = SCR_W / GRID_SIZE;  // 80 (320/4)
constexpr uint16_t MAP_ROWS     = SCR_H / GRID_SIZE;  // 60 (240/4)
