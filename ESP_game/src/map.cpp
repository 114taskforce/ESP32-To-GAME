...
void init() {
  ...
  // 上方平台
  fillRectMap(15, 20, 10, 3, CLR_WALL);
  fillRectMap(38, 20, 10, 3, CLR_WALL);

  // 中央掩体
  fillRectMap(12, 36, 4, 8, CLR_WALL);
  fillRectMap(44, 36, 4, 8, CLR_WALL);
  fillRectMap(27, 38, 6, 4, CLR_WALL);

  // 下方对称
  fillRectMap(15, 57, 10, 3, CLR_WALL);
  fillRectMap(38, 57, 10, 3, CLR_WALL);
